...
describe('SignalBadge', () => {
  ...
  it('renders SELL with red styling', () => {
    ...
    expect(screen.getByText('1.30')).toBeInTheDocument(); // absolute value
  ...
  it('shows absolute conviction for negative values', () => {
    ...
    expect(screen.getByText('2.70')).toBeInTheDocument(); // not -2.7
  });

  it('formats conviction to 2 decimal places', () => {
